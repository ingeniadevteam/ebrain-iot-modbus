...
const modbusItem = joi.object({
  ...
  fc: joi.string().valid("writeFC1", "writeFC2", "writeFC3", "writeFC4",
    "writeFC5", "writeFC6", "writeFC15", "writeFC16", "readHoldingRegisters",
    "readInputRegisters", "readDiscreteInputs", "readCoils", "writeCoil", 
    "writeRegister", "writeRegisters").default("writeFC3"),
